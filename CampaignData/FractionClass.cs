    ...
    public struct Fraction : IComparable, IFormattable
    {
        ...
        public override string ToString()
        {
            ...
            else
            {
                ...
                {
                    long whole = m_Numerator / m_Denominator;
                    long temp_num = m_Numerator % m_Denominator;

                    return whole.ToString() + " " + temp_num.ToString() + "/" + this.m_Denominator.ToString();
                }
                else
                {
        ...
        string System.IFormattable.ToString(string format, IFormatProvider formatProvider)
        {
            if (this.m_Numerator > this.m_Denominator)
            {
                ...
                return whole.ToString(format, formatProvider) + " " + temp_num.ToString(format, formatProvider) + "/" + this.m_Denominator.ToString(format, formatProvider);
            }
            else
            {

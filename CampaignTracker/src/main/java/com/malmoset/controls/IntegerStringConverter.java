...
public class IntegerStringConverter extends StringConverter<Integer> {
     ...
     * Preemptively monitors {@code input} to reject any invalid characters
     * during typing, restricts {@code input} to [{@code min}, {@code max}]
     * (inclusive) when valid text is committed, and resets {@code input} to the
     * closest value to zero within [{@code min}, {@code max}] when invalid text
     * is committed.
     *
    ...
    /**
     * Creates an {@link IntegerStringConverter} for the specified
     * {@link Spinner}. Uses the {@link TextField} and minimum and maximum
     * values of the specified {@link Spinner} for construction, and also sets
     * the new {@link IntegerStringConverter} on its
    ...
    /**
     * Sets the editor reset callback. Specify {@code null} to clear a
     * previously set {@link Runnable}. When creating an
     * {@link IntegerStringConverter} for a {@link TextField} or
